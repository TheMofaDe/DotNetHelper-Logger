public static class MyProject
{
    ...
    public static string RepositoryName { get; private set;} = "DotNetHelper-Logger";
    public static string SolutionDir  { get; private set;} = "./";
    public static string ProjectDir   { get; private set;} = "./src/DotNetHelper-Logger/";
    public static string ProjectName  { get; private set;} = "DotNetHelper-Logger"; 
    public static string SolutionFileName { get; private set;} = "DotNetHelper-Logger.sln"; 
